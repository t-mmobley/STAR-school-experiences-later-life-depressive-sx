...
# R1: TMM changing maternal and paternal edu variables to factors
analysis_deprsx_long$maternal_edu8 <-
  as.factor(ifelse(analysis_deprsx_long$maternal_edu > 8,1,0))
analysis_deprsx_long$paternal_edu8 <-
  as.factor(ifelse(analysis_deprsx_long$paternal_edu > 8,1,0))
